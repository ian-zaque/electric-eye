...
const SET_EVENTS_BY_DATE_CHART = (state, payload) => { state.eventsByDateChart = payload }
const RESET_EVENTS_BY_DATE_CHART = (state) => { state.eventsByDateChart = {} }
...
export default {
    ...
    SET_EVENTS_BY_DATE_CHART,
    RESET_EVENTS_BY_DATE_CHART,
