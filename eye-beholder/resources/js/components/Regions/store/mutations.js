...
const DELETE_REGIONS_FROM_LIST = (state, region) => {
    const index = state.regionsList.findIndex(r => r.id === region.id);
    if (index !== -1) {
        state.regionsList.splice(index, 1);
    }
}
